...
public class MatakuliahController {
    ...
    public ModelAndView index(){
        ModelAndView view = new ModelAndView("matakuliah/index");
    ...
    public ModelAndView add(){
        return new ModelAndView("matakuliah/add");
    }
    ...
    public ModelAndView edit(@PathVariable("id") String id){
        ...
        ModelAndView view = new ModelAndView("matakuliah/edit");
    ...
    public ModelAndView detail(@PathVariable("id") String id){
        ...
        ModelAndView view = new ModelAndView("matakuliah/detail");
        view.addObject("matakuliah", model);
        return view;
    }
